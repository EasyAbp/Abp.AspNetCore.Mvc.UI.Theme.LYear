...
namespace LYearUiSample.ObjectExtending
{
    public static class LYearUiSampleDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the LYearUiSampleEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
