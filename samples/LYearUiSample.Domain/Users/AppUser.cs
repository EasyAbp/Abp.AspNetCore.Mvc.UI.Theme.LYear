...
namespace LYearUiSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update LYearUiSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update LYearUiSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
